                ...
                <div class="card-body">
                    <form method="POST" action="{{route('image.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea rows="4" cols="50" id="description" type="text" name="description" class="form-control" required>{{$image->description}}</textarea>                                
                        ...
                        <div class="form-group row">                            
                            <div class="col-md-6 offset-md-3">
                                <input type="submit" class="btn btn-primary" value="Actualizar imagen"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
